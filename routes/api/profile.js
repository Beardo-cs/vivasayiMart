...
// Get GitHub credentials from environment variables first, then fall back to config
let githubClientId, githubSecret;
...
if (process.env.githubSecret) {
  ...
  try {
    ...
    console.error('GitHub Secret not found');
  }
}
...
router.get('/github/:username', async (req, res) => {
    try {
        const uri = `https://api.github.com/users/${req.params.username}/repos?per_page=5&sort=created:asc&client_id=${githubClientId}&client_secret=${githubSecret}`;
